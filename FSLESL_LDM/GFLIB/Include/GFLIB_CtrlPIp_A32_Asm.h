...
#define GFLIB_CtrlPIpInit_F16_Asmi(f16InitVal, psParam) GFLIB_CtrlPIpInit_F16_FAsmi(f16InitVal, psParam)
...
#define GFLIB_CtrlPIp_F16_Asm(f16InErr, psParam) GFLIB_CtrlPIp_F16_FAsm(f16InErr, psParam)
...
extern asm frac16_t GFLIB_CtrlPIp_F16_FAsm(frac16_t f16InErr, GFLIB_CTRL_PI_P_T_A32 *psParam);
...
* @brief  The function initializes the integral part of the PI controller.
*
* @param  ptr			GFLIB_CTRL_PI_P_T_A32 *psParam
* 						- pointer to the structure of the PI controller
*
*                         GFLIB_CTRL_PI_P_T_A32 data structure:
*                           acc32_t a32PGain    
*                               - proportional gain; input parameter
*                                 in the following range
*                                 0 <= f16PGain < 65536.0  
...
*
****************************************************************************/
extern inline void GFLIB_CtrlPIpInit_F16_FAsmi(register frac16_t f16InitVal, register GFLIB_CTRL_PI_P_T_A32 *psParam)
{
	register frac32_t f32Integral;
