...
* Macros 
******************************************************************************/
#define GFLIB_CtrlPIDpInit_F16_Asmi(f16InitVal, psParam) GFLIB_CtrlPIDpInit_F16_FAsmi(f16InitVal, psParam)
#define GFLIB_CtrlPIDpAWInit_F16_Asmi(f16InitVal, psParam) GFLIB_CtrlPIDpAWInit_F16_FAsmi(f16InitVal, psParam)

#define GFLIB_CtrlPIDp_F16_Asm(f16InErr, f16InErrD, psParam) GFLIB_CtrlPIDp_F16_FAsm(f16InErr, f16InErrD, psParam)
...
extern asm frac16_t GFLIB_CtrlPIDp_F16_FAsm(frac16_t f16InErr, frac16_t f16InErrD, GFLIB_CTRL_PID_P_T_A32 *psParam);
...
* @brief  The function initializes the integral part of the PID controller.
*
* @param  ptr			GFLIB_CTRL_PID_P_T_A32 *psParam
* 						- pointer to the structure of the PI controller
*
*                         GFLIB_CTRL_PID_P_T_A32 data structure:
*                           acc32_t a32PGain    
*                               - proportional gain; input parameter
*                                 in the following range
*                                 0 <= f16PGain < 65536.0  
...
*
****************************************************************************/
extern inline void GFLIB_CtrlPIDpInit_F16_FAsmi(register frac16_t f16InitVal, register GFLIB_CTRL_PID_P_T_A32 *psParam)
{
	register frac32_t f32Integral;
