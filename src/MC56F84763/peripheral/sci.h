...
*  SCI_VERSION_3 .. 56F802x/3x devices, see MC56F802x3xRM.pdf, 56F82xx devices, see MC56F82xxRM.pdf
*  SCI_VERSION_4 .. 56F800x devices ,see MC56F8006.pdf
*  SCI_VERSION_5 .. 56F845xx devices ,see MC56F845xxRM.pdf
*
*******************************************************************************/
...
#else
#ifndef SCI0CHAR
#define SCI0CHAR SCIxCHAR    
#endif
#ifndef SCI1CHAR
#define SCI1CHAR SCIxCHAR    
#endif
...
#define SCI_SET_FRACTIONAL_BAUDRATE  /* 0 - 7 , Fractional SCI Baud Rate divider, a value from 0 to 7 that is divided by 8 */
...
#define SCI_INT_ENABLE           /* SCI_TX_EMPTY | SCI_TX_IDLE | SCI_RX_FULL | SCI_RX_ERROR */
#define SCI_INT_DISABLE          /* SCI_TX_EMPTY | SCI_TX_IDLE | SCI_RX_FULL | SCI_RX_ERROR */
...
/****************************************************************************
* SCI Version 5 commands (845xx)
*****************************************************************************/

#if SCI_VERSION >= 5

#define SCI_DMA_RECEIVER                 /* SCI_ENABLE / SCI_DISABLE*/
#define SCI_DMA_TRANSMITTER              /* SCI_ENABLE / SCI_DISABLE*/
#define SCI_RECEIVER_IDLE_INT            /* SCI_ENABLE / SCI_DISABLE*/
#define SCI_RECEIVER_INPUT_EDGE_INT      /* SCI_ENABLE / SCI_DISABLE*/


#define STOP_MODE_ENTRY_HOLD_OFF /*Setting this bit allows the SCI to hold off chip level stop mode entry while the 
                                   transmitter is not idle or while the transmit data register is not empty.
                                   Clearing this bit means that stop mode entry is not delyed and may occur while 
                                   the SCI is actively transmitting/receiving.*/

#define SCI_RECEIVE_DMA_REQ            /* SCI_ENABLE / SCI_DISABLE*/
#define SCI_TRANSMIT_DMA_REQ           /* SCI_ENABLE / SCI_DISABLE*/
#define SCI_RECEIVER_INPUT_EDGE_FLAG   /* SCI_ENABLE / SCI_DISABLE*/
...
#if SCI_VERSION >= 4 && defined(SIM_VERSION_5)
#define SCI_BAUD_230400_3XCLOCK	  208	// error 0.16% (real: 230769) 
#define SCI_BAUD_115200_3XCLOCK	  416	// error 0.16% (real: 115384) 
#define SCI_BAUD_76800_3XCLOCK	  625	// error 0.00% (real: 76800) 
#define SCI_BAUD_57600_3XCLOCK	  833	// error 0.04% (real: 57623) 
#define SCI_BAUD_38400_3XCLOCK	 1250	// error 0.00% (real: 38400) 
#define SCI_BAUD_28800_3XCLOCK	 1666	// error 0.04% (real: 28811) 
#define SCI_BAUD_19200_3XCLOCK	 2500	// error 0.00% (real: 19200) 
#define SCI_BAUD_14400_3XCLOCK	 3333	// error 0.01% (real: 14401) 
#define SCI_BAUD_9600_3XCLOCK	 5000	// error 0.00% (real: 9600) 
#define SCI_BAUD_4800_3XCLOCK	10000	// error 0.00% (real: 4800) 
#define SCI_BAUD_2400_3XCLOCK	20000	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200_3XCLOCK	40000	// error 0.00% (real: 1200) 
#endif

#if SCI_VERSION >= 3 && defined(SIM_VERSION_6)
#define SCI_BAUD_230400_2XCLOCK	  138	// error 0.64% (real: 231884) 
#define SCI_BAUD_115200_2XCLOCK	  277	// error 0.28% (real: 115523) 
#define SCI_BAUD_76800_2XCLOCK	  416	// error 0.16% (real: 76923) 
#define SCI_BAUD_57600_2XCLOCK	  555	// error 0.10% (real: 57657) 
#define SCI_BAUD_38400_2XCLOCK	  833	// error 0.04% (real: 38415) 
#define SCI_BAUD_28800_2XCLOCK	 1111	// error 0.01% (real: 28802) 
#define SCI_BAUD_19200_2XCLOCK	 1666	// error 0.04% (real: 19207) 
#define SCI_BAUD_14400_2XCLOCK	 2222	// error 0.01% (real: 14401) 
#define SCI_BAUD_9600_2XCLOCK	 3333	// error 0.00% (real: 9600) 
#define SCI_BAUD_4800_2XCLOCK	 6666	// error 0.00% (real: 4800) 
#define SCI_BAUD_2400_2XCLOCK	13333	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200_2XCLOCK	26666	// error 0.00% (real: 1200) 
#define SCI_BAUD_600_2XCLOCK	53333	// error 0.00% (real: 600) 
#endif
...
#if SCI_VERSION >= 4 && defined(SIM_VERSION_5)
#define SCI_BAUD_230400_3XCLOCK	  130	// error 0.16% (real: 230769) 
#define SCI_BAUD_115200_3XCLOCK	  260	// error 0.16% (real: 115384) 
#define SCI_BAUD_76800_3XCLOCK	  390	// error 0.16% (real: 76923) 
#define SCI_BAUD_57600_3XCLOCK	  520	// error 0.16% (real: 57692) 
#define SCI_BAUD_38400_3XCLOCK	  781	// error 0.03% (real: 38412) 
#define SCI_BAUD_28800_3XCLOCK	 1041	// error 0.06% (real: 28818) 
#define SCI_BAUD_19200_3XCLOCK	 1562	// error 0.03% (real: 19206) 
#define SCI_BAUD_14400_3XCLOCK	 2083	// error 0.01% (real: 14402) 
#define SCI_BAUD_9600_3XCLOCK	 3125	// error 0.00% (real: 9600) 
#define SCI_BAUD_4800_3XCLOCK	 6250	// error 0.00% (real: 4800) 
#define SCI_BAUD_2400_3XCLOCK	12500	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200_3XCLOCK	25000	// error 0.00% (real: 1200) 
#define SCI_BAUD_600_3XCLOCK	50000	// error 0.00% (real: 600) 
#endif

#if SCI_VERSION >= 3 && defined(SIM_VERSION_6)
#define SCI_BAUD_230400_2XCLOCK	   86	// error 0.94% (real: 232558) 
#define SCI_BAUD_115200_2XCLOCK	  173	// error 0.35% (real: 115606) 
#define SCI_BAUD_76800_2XCLOCK	  260	// error 0.16% (real: 76923) 
#define SCI_BAUD_57600_2XCLOCK	  347	// error 0.06% (real: 57636) 
#define SCI_BAUD_38400_2XCLOCK	  520	// error 0.16% (real: 38461) 
#define SCI_BAUD_28800_2XCLOCK	  694	// error 0.06% (real: 28818) 
#define SCI_BAUD_19200_2XCLOCK	 1041	// error 0.06% (real: 19212) 
#define SCI_BAUD_14400_2XCLOCK	 1388	// error 0.06% (real: 14409) 
#define SCI_BAUD_9600_2XCLOCK	 2083	// error 0.01% (real: 9601) 
#define SCI_BAUD_4800_2XCLOCK	 4166	// error 0.00% (real: 4800) 
#define SCI_BAUD_2400_2XCLOCK	 8333	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200_2XCLOCK	16666	// error 0.00% (real: 1200) 
#define SCI_BAUD_600_2XCLOCK	33333	// error 0.00% (real: 600) 
#endif
...
#if SCI_VERSION >= 4 && defined(SIM_VERSION_5)
#define SCI_BAUD_230400_3XCLOCK	  104	// error 0.16% (real: 230769) 
#define SCI_BAUD_115200_3XCLOCK	  208	// error 0.16% (real: 115384) 
#define SCI_BAUD_76800_3XCLOCK	  312	// error 0.16% (real: 76923) 
#define SCI_BAUD_57600_3XCLOCK	  416	// error 0.16% (real: 57692) 
#define SCI_BAUD_38400_3XCLOCK	  625	// error 0.00% (real: 38400) 
#define SCI_BAUD_28800_3XCLOCK	  833	// error 0.04% (real: 28811) 
#define SCI_BAUD_19200_3XCLOCK	 1250	// error 0.00% (real: 19200) 
#define SCI_BAUD_14400_3XCLOCK	 1666	// error 0.03% (real: 14405) 
#define SCI_BAUD_9600_3XCLOCK	 2500	// error 0.00% (real: 9600) 
#define SCI_BAUD_4800_3XCLOCK	 5000	// error 0.00% (real: 4800) 
#define SCI_BAUD_2400_3XCLOCK	10000	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200_3XCLOCK	20000	// error 0.00% (real: 1200) 
#define SCI_BAUD_600_3XCLOCK	40000	// error 0.00% (real: 600) 
#endif

#if SCI_VERSION >= 3 && defined(SIM_VERSION_6)
#define SCI_BAUD_230400_2XCLOCK	   69	// error 0.64% (real: 231884) 
#define SCI_BAUD_115200_2XCLOCK	  138	// error 0.64% (real: 115942) 
#define SCI_BAUD_76800_2XCLOCK	  208	// error 0.16% (real: 76923) 
#define SCI_BAUD_57600_2XCLOCK	  277	// error 0.28% (real: 57761) 
#define SCI_BAUD_38400_2XCLOCK	  416	// error 0.16% (real: 38461) 
#define SCI_BAUD_28800_2XCLOCK	  555	// error 0.10% (real: 28828) 
#define SCI_BAUD_19200_2XCLOCK	  833	// error 0.04% (real: 19207) 
#define SCI_BAUD_14400_2XCLOCK	 1111	// error 0.01% (real: 14401) 
#define SCI_BAUD_9600_2XCLOCK	 1666	// error 0.03% (real: 9603) 
#define SCI_BAUD_4800_2XCLOCK	 3333	// error 0.00% (real: 4800) 
#define SCI_BAUD_2400_2XCLOCK	 6666	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200_2XCLOCK	13333	// error 0.00% (real: 1200) 
#define SCI_BAUD_600_2XCLOCK	26666	// error 0.00% (real: 600) 
#endif
...
#if SCI_VERSION >= 4 && defined(SIM_VERSION_5)
#define SCI_BAUD_230400_3XCLOCK	   52	// error 0.16% (real: 230769) 
#define SCI_BAUD_115200_3XCLOCK	  104	// error 0.16% (real: 115384) 
#define SCI_BAUD_76800_3XCLOCK	  156	// error 0.16% (real: 76923) 
#define SCI_BAUD_57600_3XCLOCK	  208	// error 0.16% (real: 57692) 
#define SCI_BAUD_38400_3XCLOCK	  312	// error 0.16% (real: 38461) 
#define SCI_BAUD_28800_3XCLOCK	  416	// error 0.16% (real: 28846) 
#define SCI_BAUD_19200_3XCLOCK	  625	// error 0.00% (real: 19200) 
#define SCI_BAUD_14400_3XCLOCK	  833	// error 0.03% (real: 14405) 
#define SCI_BAUD_9600_3XCLOCK	 1250	// error 0.00% (real: 9600) 
#define SCI_BAUD_4800_3XCLOCK	 2500	// error 0.00% (real: 4800) 
#define SCI_BAUD_2400_3XCLOCK	 5000	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200_3XCLOCK	10000	// error 0.00% (real: 1200) 
#define SCI_BAUD_600_3XCLOCK	20000	// error 0.00% (real: 600) 
#endif

#if SCI_VERSION >= 3 && defined(SIM_VERSION_6)
#define SCI_BAUD_230400_2XCLOCK	   34	// error 2.12% (real: 235294) 
#define SCI_BAUD_115200_2XCLOCK	   69	// error 0.64% (real: 115942) 
#define SCI_BAUD_76800_2XCLOCK	  104	// error 0.16% (real: 76923) 
#define SCI_BAUD_57600_2XCLOCK	  138	// error 0.64% (real: 57971) 
#define SCI_BAUD_38400_2XCLOCK	  208	// error 0.16% (real: 38461) 
#define SCI_BAUD_28800_2XCLOCK	  277	// error 0.28% (real: 28880) 
#define SCI_BAUD_19200_2XCLOCK	  416	// error 0.16% (real: 19230) 
#define SCI_BAUD_14400_2XCLOCK	  555	// error 0.10% (real: 14414) 
#define SCI_BAUD_9600_2XCLOCK	  833	// error 0.03% (real: 9603) 
#define SCI_BAUD_4800_2XCLOCK	 1666	// error 0.02% (real: 4801) 
#define SCI_BAUD_2400_2XCLOCK	 3333	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200_2XCLOCK	 6666	// error 0.00% (real: 1200) 
#define SCI_BAUD_600_2XCLOCK	13333	// error 0.00% (real: 600) 
#endif
...
#if SCI_VERSION >= 4 && defined(SIM_VERSION_5)
#define SCI_BAUD_230400_3XCLOCK	   26	// error 0.16% (real: 230769) 
#define SCI_BAUD_115200_3XCLOCK	   52	// error 0.16% (real: 115384) 
#define SCI_BAUD_76800_3XCLOCK	   78	// error 0.16% (real: 76923) 
#define SCI_BAUD_57600_3XCLOCK	  104	// error 0.16% (real: 57692) 
#define SCI_BAUD_38400_3XCLOCK	  156	// error 0.16% (real: 38461) 
#define SCI_BAUD_28800_3XCLOCK	  208	// error 0.16% (real: 28846) 
#define SCI_BAUD_19200_3XCLOCK	  312	// error 0.16% (real: 19230) 
#define SCI_BAUD_14400_3XCLOCK	  416	// error 0.16% (real: 14423) 
#define SCI_BAUD_9600_3XCLOCK	  625	// error 0.00% (real: 9600) 
#define SCI_BAUD_4800_3XCLOCK	 1250	// error 0.00% (real: 4800) 
#define SCI_BAUD_2400_3XCLOCK	 2500	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200_3XCLOCK	 5000	// error 0.00% (real: 1200) 
#define SCI_BAUD_600_3XCLOCK	10000	// error 0.00% (real: 600) 
#endif

#if SCI_VERSION >= 3 && defined(SIM_VERSION_6)
#define SCI_BAUD_230400_2XCLOCK	   17	// error 2.12% (real: 235294) 
#define SCI_BAUD_115200_2XCLOCK	   34	// error 2.12% (real: 117647) 
#define SCI_BAUD_76800_2XCLOCK	   52	// error 0.16% (real: 76923) 
#define SCI_BAUD_57600_2XCLOCK	   69	// error 0.64% (real: 57971) 
#define SCI_BAUD_38400_2XCLOCK	  104	// error 0.16% (real: 38461) 
#define SCI_BAUD_28800_2XCLOCK	  138	// error 0.64% (real: 28985) 
#define SCI_BAUD_19200_2XCLOCK	  208	// error 0.16% (real: 19230) 
#define SCI_BAUD_14400_2XCLOCK	  277	// error 0.28% (real: 14440) 
#define SCI_BAUD_9600_2XCLOCK	  416	// error 0.16% (real: 9615) 
#define SCI_BAUD_4800_2XCLOCK	  833	// error 0.02% (real: 4801) 
#define SCI_BAUD_2400_2XCLOCK	 1666	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200_2XCLOCK	 3333	// error 0.00% (real: 1200) 
#define SCI_BAUD_600_2XCLOCK	 6666	// error 0.00% (real: 600) 
#endif
...
#if SCI_VERSION >= 4 && defined(SIM_VERSION_5)
#define SCI_BAUD_230400_3XCLOCK	   13	// error 0.16% (real: 230769) 
#define SCI_BAUD_115200_3XCLOCK	   26	// error 0.16% (real: 115384) 
#define SCI_BAUD_76800_3XCLOCK	   39	// error 0.16% (real: 76923) 
#define SCI_BAUD_57600_3XCLOCK	   52	// error 0.16% (real: 57692) 
#define SCI_BAUD_38400_3XCLOCK	   78	// error 0.16% (real: 38461) 
#define SCI_BAUD_28800_3XCLOCK	  104	// error 0.16% (real: 28846) 
#define SCI_BAUD_19200_3XCLOCK	  156	// error 0.16% (real: 19230) 
#define SCI_BAUD_14400_3XCLOCK	  208	// error 0.16% (real: 14423) 
#define SCI_BAUD_9600_3XCLOCK	  312	// error 0.16% (real: 9615) 
#define SCI_BAUD_4800_3XCLOCK	  625	// error 0.00% (real: 4800) 
#define SCI_BAUD_2400_3XCLOCK	 1250	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200_3XCLOCK	 2500	// error 0.00% (real: 1200) 
#define SCI_BAUD_600_3XCLOCK	 5000	// error 0.00% (real: 600) 
#endif

#if SCI_VERSION >= 3 && defined(SIM_VERSION_6)
#define SCI_BAUD_230400_2XCLOCK	    8	// error 8.51% (real: 250000) 
#define SCI_BAUD_115200_2XCLOCK	   17	// error 2.12% (real: 117647) 
#define SCI_BAUD_76800_2XCLOCK	   26	// error 0.16% (real: 76923) 
#define SCI_BAUD_57600_2XCLOCK	   34	// error 2.12% (real: 58823) 
#define SCI_BAUD_38400_2XCLOCK	   52	// error 0.16% (real: 38461) 
#define SCI_BAUD_28800_2XCLOCK	   69	// error 0.64% (real: 28985) 
#define SCI_BAUD_19200_2XCLOCK	  104	// error 0.16% (real: 19230) 
#define SCI_BAUD_14400_2XCLOCK	  138	// error 0.64% (real: 14492) 
#define SCI_BAUD_9600_2XCLOCK	  208	// error 0.16% (real: 9615) 
#define SCI_BAUD_4800_2XCLOCK	  416	// error 0.15% (real: 4807) 
#define SCI_BAUD_2400_2XCLOCK	  833	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200_2XCLOCK	 1666	// error 0.00% (real: 1200) 
#define SCI_BAUD_600_2XCLOCK	 3333	// error 0.00% (real: 600) 
#endif
...
#if SCI_VERSION >= 4 && defined(SIM_VERSION_5)
#define SCI_BAUD_115200_3XCLOCK	   13	// error 0.16% (real: 115384) 
#define SCI_BAUD_76800_3XCLOCK	   19	// error 2.80% (real: 78947) 
#define SCI_BAUD_57600_3XCLOCK	   26	// error 0.16% (real: 57692) 
#define SCI_BAUD_38400_3XCLOCK	   39	// error 0.16% (real: 38461) 
#define SCI_BAUD_28800_3XCLOCK	   52	// error 0.16% (real: 28846) 
#define SCI_BAUD_19200_3XCLOCK	   78	// error 0.16% (real: 19230) 
#define SCI_BAUD_14400_3XCLOCK	  104	// error 0.16% (real: 14423) 
#define SCI_BAUD_9600_3XCLOCK	  156	// error 0.16% (real: 9615) 
#define SCI_BAUD_4800_3XCLOCK	  312	// error 0.15% (real: 4807) 
#define SCI_BAUD_2400_3XCLOCK	  625	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200_3XCLOCK	 1250	// error 0.00% (real: 1200) 
#define SCI_BAUD_600_3XCLOCK	 2500	// error 0.00% (real: 600) 
#endif

#if SCI_VERSION >= 3 && defined(SIM_VERSION_6)
#define SCI_BAUD_115200_2XCLOCK	    8	// error 8.51% (real: 125000) 
#define SCI_BAUD_76800_2XCLOCK	   13	// error 0.16% (real: 76923) 
#define SCI_BAUD_57600_2XCLOCK	   17	// error 2.12% (real: 58823) 
#define SCI_BAUD_38400_2XCLOCK	   26	// error 0.16% (real: 38461) 
#define SCI_BAUD_28800_2XCLOCK	   34	// error 2.12% (real: 29411) 
#define SCI_BAUD_19200_2XCLOCK	   52	// error 0.16% (real: 19230) 
#define SCI_BAUD_14400_2XCLOCK	   69	// error 0.64% (real: 14492) 
#define SCI_BAUD_9600_2XCLOCK	  104	// error 0.16% (real: 9615) 
#define SCI_BAUD_4800_2XCLOCK	  208	// error 0.15% (real: 4807) 
#define SCI_BAUD_2400_2XCLOCK	  416	// error 0.12% (real: 2403) 
#define SCI_BAUD_1200_2XCLOCK	  833	// error 0.00% (real: 1200) 
#define SCI_BAUD_600_2XCLOCK	 1666	// error 0.00% (real: 600) 
#endif

//frequency 60000000
#elif (SCI_CORE_FREQ) == 60000000 && SCI_VERSION >= 3 && defined(OCCS_VERSION_5)
#define SCI_BAUD_230400	  130	// error 0.16% (real: 230769) 
#define SCI_BAUD_115200	  260	// error 0.16% (real: 115384) 
#define SCI_BAUD_76800	  390	// error 0.16% (real: 76923) 
#define SCI_BAUD_57600	  520	// error 0.16% (real: 57692) 
#define SCI_BAUD_38400	  781	// error 0.03% (real: 38412) 
#define SCI_BAUD_28800	 1041	// error 0.06% (real: 28818) 
#define SCI_BAUD_19200	 1562	// error 0.03% (real: 19206) 
#define SCI_BAUD_14400	 2083	// error 0.01% (real: 14402) 
#define SCI_BAUD_9600	 3125	// error 0.00% (real: 9600) 
#define SCI_BAUD_4800	 6250	// error 0.00% (real: 4800) 
#define SCI_BAUD_2400	12500	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200	25000	// error 0.00% (real: 1200) 
#define SCI_BAUD_600	50000	// error 0.00% (real: 600) 

#ifdef SIM_VERSION_6
#define SCI_BAUD_230400_2XCLOCK	  260	// error 0.16% (real: 230769) 
#define SCI_BAUD_115200_2XCLOCK	  520	// error 0.16% (real: 115384) 
#define SCI_BAUD_76800_2XCLOCK	  781	// error 0.03% (real: 76824) 
#define SCI_BAUD_57600_2XCLOCK	 1041	// error 0.06% (real: 57636) 
#define SCI_BAUD_38400_2XCLOCK	 1562	// error 0.03% (real: 38412) 
#define SCI_BAUD_28800_2XCLOCK	 2083	// error 0.01% (real: 28804) 
#define SCI_BAUD_19200_2XCLOCK	 3125	// error 0.00% (real: 19200) 
#define SCI_BAUD_14400_2XCLOCK	 4166	// error 0.01% (real: 14402) 
#define SCI_BAUD_9600_2XCLOCK	 6250	// error 0.00% (real: 9600) 
#define SCI_BAUD_4800_2XCLOCK	12500	// error 0.00% (real: 4800) 
#define SCI_BAUD_2400_2XCLOCK	25000	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200_2XCLOCK	50000	// error 0.00% (real: 1200) 
#endif


//frequency 30000000
#elif (SCI_CORE_FREQ) == 30000000 && SCI_VERSION >= 3 && defined(OCCS_VERSION_5)
#define SCI_BAUD_230400	   65	// error 0.16% (real: 230769) 
#define SCI_BAUD_115200	  130	// error 0.16% (real: 115384) 
#define SCI_BAUD_76800	  195	// error 0.16% (real: 76923) 
#define SCI_BAUD_57600	  260	// error 0.16% (real: 57692) 
#define SCI_BAUD_38400	  390	// error 0.16% (real: 38461) 
#define SCI_BAUD_28800	  520	// error 0.16% (real: 28846) 
#define SCI_BAUD_19200	  781	// error 0.03% (real: 19206) 
#define SCI_BAUD_14400	 1041	// error 0.06% (real: 14409) 
#define SCI_BAUD_9600	 1562	// error 0.03% (real: 9603) 
#define SCI_BAUD_4800	 3125	// error 0.00% (real: 4800) 
#define SCI_BAUD_2400	 6250	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200	12500	// error 0.00% (real: 1200) 
#define SCI_BAUD_600	25000	// error 0.00% (real: 600) 

#ifdef SIM_VERSION_6
#define SCI_BAUD_230400_2XCLOCK	  130	// error 0.16% (real: 230769) 
#define SCI_BAUD_115200_2XCLOCK	  260	// error 0.16% (real: 115384) 
#define SCI_BAUD_76800_2XCLOCK	  390	// error 0.16% (real: 76923) 
#define SCI_BAUD_57600_2XCLOCK	  520	// error 0.16% (real: 57692) 
#define SCI_BAUD_38400_2XCLOCK	  781	// error 0.03% (real: 38412) 
#define SCI_BAUD_28800_2XCLOCK	 1041	// error 0.06% (real: 28818) 
#define SCI_BAUD_19200_2XCLOCK	 1562	// error 0.03% (real: 19206) 
#define SCI_BAUD_14400_2XCLOCK	 2083	// error 0.01% (real: 14402) 
#define SCI_BAUD_9600_2XCLOCK	 3125	// error 0.00% (real: 9600) 
#define SCI_BAUD_4800_2XCLOCK	 6250	// error 0.00% (real: 4800) 
#define SCI_BAUD_2400_2XCLOCK	12500	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200_2XCLOCK	25000	// error 0.00% (real: 1200) 
#define SCI_BAUD_600_2XCLOCK	50000	// error 0.00% (real: 600) 
#endif


//frequency 15000000
#elif (SCI_CORE_FREQ) == 15000000 && SCI_VERSION >= 3 && defined(OCCS_VERSION_5)
#define SCI_BAUD_230400	   32	// error 1.73% (real: 234375) 
#define SCI_BAUD_115200	   65	// error 0.16% (real: 115384) 
#define SCI_BAUD_76800	   97	// error 0.68% (real: 77319) 
#define SCI_BAUD_57600	  130	// error 0.16% (real: 57692) 
#define SCI_BAUD_38400	  195	// error 0.16% (real: 38461) 
#define SCI_BAUD_28800	  260	// error 0.16% (real: 28846) 
#define SCI_BAUD_19200	  390	// error 0.16% (real: 19230) 
#define SCI_BAUD_14400	  520	// error 0.16% (real: 14423) 
#define SCI_BAUD_9600	  781	// error 0.03% (real: 9603) 
#define SCI_BAUD_4800	 1562	// error 0.02% (real: 4801) 
#define SCI_BAUD_2400	 3125	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200	 6250	// error 0.00% (real: 1200) 
#define SCI_BAUD_600	12500	// error 0.00% (real: 600) 

#ifdef SIM_VERSION_6
#define SCI_BAUD_230400_2XCLOCK	   65	// error 0.16% (real: 230769) 
#define SCI_BAUD_115200_2XCLOCK	  130	// error 0.16% (real: 115384) 
#define SCI_BAUD_76800_2XCLOCK	  195	// error 0.16% (real: 76923) 
#define SCI_BAUD_57600_2XCLOCK	  260	// error 0.16% (real: 57692) 
#define SCI_BAUD_38400_2XCLOCK	  390	// error 0.16% (real: 38461) 
#define SCI_BAUD_28800_2XCLOCK	  520	// error 0.16% (real: 28846) 
#define SCI_BAUD_19200_2XCLOCK	  781	// error 0.03% (real: 19206) 
#define SCI_BAUD_14400_2XCLOCK	 1041	// error 0.06% (real: 14409) 
#define SCI_BAUD_9600_2XCLOCK	 1562	// error 0.03% (real: 9603) 
#define SCI_BAUD_4800_2XCLOCK	 3125	// error 0.00% (real: 4800) 
#define SCI_BAUD_2400_2XCLOCK	 6250	// error 0.00% (real: 2400) 
#define SCI_BAUD_1200_2XCLOCK	12500	// error 0.00% (real: 1200) 
#define SCI_BAUD_600_2XCLOCK	25000	// error 0.00% (real: 600) 
#endif


//frequency 100000000
#elif (SCI_CORE_FREQ) == 100000000 && SCI_VERSION >= 3 && defined(OCCS_VERSION_6)
#define SCI_BAUD_230400   217   // error 0.01% (real: 230414) 
#define SCI_BAUD_115200   434   // error 0.01% (real: 115207) 
#define SCI_BAUD_76800    651   // error 0.01% (real: 76804) 
#define SCI_BAUD_57600    868   // error 0.01% (real: 57603) 
#define SCI_BAUD_38400   1302   // error 0.01% (real: 38402) 
#define SCI_BAUD_28800   1736   // error 0.00% (real: 28801) 
#define SCI_BAUD_19200   2604   // error 0.01% (real: 19201) 
#define SCI_BAUD_14400   3472   // error 0.00% (real: 14400) 
#define SCI_BAUD_9600    5208   // error 0.00% (real: 9600) 
#define SCI_BAUD_4800   10416   // error 0.00% (real: 4800) 
#define SCI_BAUD_2400   20833   // error 0.00% (real: 2400) 
#define SCI_BAUD_1200   41666   // error 0.00% (real: 1200) 

#if defined(SIM_VERSION_7)
#define SCI_BAUD_230400_2XCLOCK   434   // error 0.01% (real: 230414) 
#define SCI_BAUD_115200_2XCLOCK   868   // error 0.01% (real: 115207) 
#define SCI_BAUD_76800_2XCLOCK   1302   // error 0.01% (real: 76804) 
#define SCI_BAUD_57600_2XCLOCK   1736   // error 0.01% (real: 57603) 
#define SCI_BAUD_38400_2XCLOCK   2604   // error 0.01% (real: 38402) 
#define SCI_BAUD_28800_2XCLOCK   3472   // error 0.00% (real: 28801) 
#define SCI_BAUD_19200_2XCLOCK   5208   // error 0.01% (real: 19201) 
#define SCI_BAUD_14400_2XCLOCK   6944   // error 0.00% (real: 14400) 
#define SCI_BAUD_9600_2XCLOCK   10416   // error 0.00% (real: 9600) 
#define SCI_BAUD_4800_2XCLOCK   20833   // error 0.00% (real: 4800) 
#define SCI_BAUD_2400_2XCLOCK   41666   // error 0.00% (real: 2400) 
#endif


//frequency 80000000
#elif (SCI_CORE_FREQ) == 80000000 && SCI_VERSION >= 3 && defined(OCCS_VERSION_6)
#define SCI_BAUD_230400   173   // error 0.35% (real: 231213) 
#define SCI_BAUD_115200   347   // error 0.06% (real: 115273) 
#define SCI_BAUD_76800    520   // error 0.16% (real: 76923) 
#define SCI_BAUD_57600    694   // error 0.06% (real: 57636) 
#define SCI_BAUD_38400   1041   // error 0.06% (real: 38424) 
#define SCI_BAUD_28800   1388   // error 0.06% (real: 28818) 
#define SCI_BAUD_19200   2083   // error 0.02% (real: 19203) 
#define SCI_BAUD_14400   2777   // error 0.03% (real: 14404) 
#define SCI_BAUD_9600    4166   // error 0.01% (real: 9601) 
#define SCI_BAUD_4800    8333   // error 0.00% (real: 4800) 
#define SCI_BAUD_2400   16666   // error 0.00% (real: 2400) 
#define SCI_BAUD_1200   33333   // error 0.00% (real: 1200) 

#if defined(SIM_VERSION_7)
#define SCI_BAUD_230400_2XCLOCK   347   // error 0.06% (real: 230547) 
#define SCI_BAUD_115200_2XCLOCK   694   // error 0.06% (real: 115273) 
#define SCI_BAUD_76800_2XCLOCK   1041   // error 0.06% (real: 76849) 
#define SCI_BAUD_57600_2XCLOCK   1388   // error 0.06% (real: 57636) 
#define SCI_BAUD_38400_2XCLOCK   2083   // error 0.02% (real: 38406) 
#define SCI_BAUD_28800_2XCLOCK   2777   // error 0.03% (real: 28808) 
#define SCI_BAUD_19200_2XCLOCK   4166   // error 0.02% (real: 19203) 
#define SCI_BAUD_14400_2XCLOCK   5555   // error 0.01% (real: 14401) 
#define SCI_BAUD_9600_2XCLOCK    8333   // error 0.00% (real: 9600) 
#define SCI_BAUD_4800_2XCLOCK   16666   // error 0.00% (real: 4800) 
#define SCI_BAUD_2400_2XCLOCK   33333   // error 0.00% (real: 2400) 
#endif


//frequency 60000000
#elif (SCI_CORE_FREQ) == 60000000 && SCI_VERSION >= 3 && defined(OCCS_VERSION_6)
#define SCI_BAUD_230400   130   // error 0.16% (real: 230769) 
#define SCI_BAUD_115200   260   // error 0.16% (real: 115384) 
#define SCI_BAUD_76800    390   // error 0.16% (real: 76923) 
#define SCI_BAUD_57600    520   // error 0.16% (real: 57692) 
...
//frequency 50000000
#elif (SCI_CORE_FREQ) == 50000000 && SCI_VERSION >= 3 && defined(OCCS_VERSION_6)
#define SCI_BAUD_230400   108   // error 0.47% (real: 231481) 
#define SCI_BAUD_115200   217   // error 0.01% (real: 115207) 
#define SCI_BAUD_76800    325   // error 0.16% (real: 76923) 
#define SCI_BAUD_57600    434   // error 0.01% (real: 57603) 
#define SCI_BAUD_38400    651   // error 0.01% (real: 38402) 
#define SCI_BAUD_28800    868   // error 0.00% (real: 28801) 
#define SCI_BAUD_19200   1302   // error 0.01% (real: 19201) 
#define SCI_BAUD_14400   1736   // error 0.00% (real: 14400) 
#define SCI_BAUD_9600    2604   // error 0.00% (real: 9600) 
#define SCI_BAUD_4800    5208   // error 0.00% (real: 4800) 
#define SCI_BAUD_2400   10416   // error 0.00% (real: 2400) 
#define SCI_BAUD_1200   20833   // error 0.00% (real: 1200) 
#define SCI_BAUD_600    41666   // error 0.00% (real: 600) 

#if defined(SIM_VERSION_7)
#define SCI_BAUD_230400_2XCLOCK   217   // error 0.01% (real: 230414) 
#define SCI_BAUD_115200_2XCLOCK   434   // error 0.01% (real: 115207) 
#define SCI_BAUD_76800_2XCLOCK    651   // error 0.01% (real: 76804) 
#define SCI_BAUD_57600_2XCLOCK    868   // error 0.01% (real: 57603) 
#define SCI_BAUD_38400_2XCLOCK   1302   // error 0.01% (real: 38402) 
#define SCI_BAUD_28800_2XCLOCK   1736   // error 0.00% (real: 28801) 
#define SCI_BAUD_19200_2XCLOCK   2604   // error 0.01% (real: 19201) 
#define SCI_BAUD_14400_2XCLOCK   3472   // error 0.00% (real: 14400) 
#define SCI_BAUD_9600_2XCLOCK    5208   // error 0.00% (real: 9600) 
#define SCI_BAUD_4800_2XCLOCK   10416   // error 0.00% (real: 4800) 
#define SCI_BAUD_2400_2XCLOCK   20833   // error 0.00% (real: 2400) 
#define SCI_BAUD_1200_2XCLOCK   41666   // error 0.00% (real: 1200) 
#endif


//frequency 40000000
#elif (SCI_CORE_FREQ) == 40000000 && SCI_VERSION >= 3 && defined(OCCS_VERSION_6)
#define SCI_BAUD_230400	   86   // error 0.94% (real: 232558) 
#define SCI_BAUD_115200	  173   // error 0.35% (real: 115606) 
#define SCI_BAUD_76800	  260   // error 0.16% (real: 76923) 
#define SCI_BAUD_57600	  347   // error 0.06% (real: 57636) 
#define SCI_BAUD_38400	  520   // error 0.16% (real: 38461) 
#define SCI_BAUD_28800	  694   // error 0.06% (real: 28818) 
#define SCI_BAUD_19200	 1041   // error 0.06% (real: 19212) 
#define SCI_BAUD_14400	 1388   // error 0.06% (real: 14409) 
#define SCI_BAUD_9600	 2083   // error 0.01% (real: 9601) 
#define SCI_BAUD_4800	 4166   // error 0.00% (real: 4800) 
#define SCI_BAUD_2400	 8333   // error 0.00% (real: 2400) 
#define SCI_BAUD_1200	16666   // error 0.00% (real: 1200) 
#define SCI_BAUD_600	33333   // error 0.00% (real: 600) 

#if defined(SIM_VERSION_7)
#define SCI_BAUD_230400_2XCLOCK   173   // error 0.35% (real: 231213) 
#define SCI_BAUD_115200_2XCLOCK   347   // error 0.06% (real: 115273) 
#define SCI_BAUD_76800_2XCLOCK    520   // error 0.16% (real: 76923) 
#define SCI_BAUD_57600_2XCLOCK    694   // error 0.06% (real: 57636) 
#define SCI_BAUD_38400_2XCLOCK   1041   // error 0.06% (real: 38424) 
#define SCI_BAUD_28800_2XCLOCK   1388   // error 0.06% (real: 28818) 
#define SCI_BAUD_19200_2XCLOCK   2083   // error 0.02% (real: 19203) 
#define SCI_BAUD_14400_2XCLOCK   2777   // error 0.03% (real: 14404) 
#define SCI_BAUD_9600_2XCLOCK    4166   // error 0.01% (real: 9601) 
#define SCI_BAUD_4800_2XCLOCK    8333   // error 0.00% (real: 4800) 
#define SCI_BAUD_2400_2XCLOCK   16666   // error 0.00% (real: 2400) 
#define SCI_BAUD_1200_2XCLOCK   33333   // error 0.00% (real: 1200) 
#endif


//frequency 32000000
#elif (SCI_CORE_FREQ) == 32000000 && SCI_VERSION >= 3 && defined(OCCS_VERSION_6)
#define SCI_BAUD_230400    69   // error 0.64% (real: 231884) 
#define SCI_BAUD_115200   138   // error 0.64% (real: 115942) 
#define SCI_BAUD_76800    208   // error 0.16% (real: 76923) 
#define SCI_BAUD_57600    277   // error 0.28% (real: 57761) 
...
//frequency 30000000
#elif (SCI_CORE_FREQ) == 30000000 && SCI_VERSION >= 3 && defined(OCCS_VERSION_6)
#define SCI_BAUD_230400    65   // error 0.16% (real: 230769) 
#define SCI_BAUD_115200   130   // error 0.16% (real: 115384) 
#define SCI_BAUD_76800    195   // error 0.16% (real: 76923) 
#define SCI_BAUD_57600    260   // error 0.16% (real: 57692) 
...
//frequency 16000000
#elif (SCI_CORE_FREQ) == 16000000 && SCI_VERSION >= 3 && defined(OCCS_VERSION_6)
#define SCI_BAUD_230400    34   // error 2.12% (real: 235294) 
#define SCI_BAUD_115200    69   // error 0.64% (real: 115942) 
#define SCI_BAUD_76800    104   // error 0.16% (real: 76923) 
#define SCI_BAUD_57600    138   // error 0.64% (real: 57971) 
...
//frequency 50000000
#elif (SCI_CORE_FREQ) == 50000000 && SCI_VERSION >= 3 && defined(OCCS_VERSION_7)
#define SCI_BAUD_230400   108   // error 0.47% (real: 231481) 
#define SCI_BAUD_115200   217   // error 0.01% (real: 115207) 
#define SCI_BAUD_76800    325   // error 0.16% (real: 76923) 
#define SCI_BAUD_57600    434   // error 0.01% (real: 57603) 
...
//frequency 40000000
#elif (SCI_CORE_FREQ) == 40000000 && SCI_VERSION >= 3 && defined(OCCS_VERSION_7)
#define SCI_BAUD_230400    86   // error 0.94% (real: 232558) 
#define SCI_BAUD_115200   173   // error 0.35% (real: 115606) 
#define SCI_BAUD_76800    260   // error 0.16% (real: 76923) 
#define SCI_BAUD_57600    347   // error 0.06% (real: 57636) 
...
//frequency 32000000
#elif (SCI_CORE_FREQ) == 32000000 && SCI_VERSION >= 3 && defined(OCCS_VERSION_7)
#define SCI_BAUD_230400    69   // error 0.64% (real: 231884) 
#define SCI_BAUD_115200   138   // error 0.64% (real: 115942) 
#define SCI_BAUD_76800    208   // error 0.16% (real: 76923) 
#define SCI_BAUD_57600    277   // error 0.28% (real: 57761) 
...
//frequency 30000000
#elif (SCI_CORE_FREQ) == 30000000 && SCI_VERSION >= 3 && defined(OCCS_VERSION_7)
#define SCI_BAUD_230400    65   // error 0.16% (real: 230769) 
#define SCI_BAUD_115200   130   // error 0.16% (real: 115384) 
#define SCI_BAUD_76800    195   // error 0.16% (real: 76923) 
#define SCI_BAUD_57600    260   // error 0.16% (real: 57692) 
...
//frequency 16000000
#elif (SCI_CORE_FREQ) == 16000000 && SCI_VERSION >= 3 && defined(OCCS_VERSION_7)
#define SCI_BAUD_230400    34   // error 2.12% (real: 235294) 
#define SCI_BAUD_115200    69   // error 0.64% (real: 115942) 
#define SCI_BAUD_76800    104   // error 0.16% (real: 76923) 
#define SCI_BAUD_57600    138   // error 0.64% (real: 57971) 
...
#if SCI_VERSION >= 5
/* SCI CTRL2 bits */
#define SCI_CTRL2_RDE		0x0001
#define SCI_CTRL2_TDE		0x0002
#define SCI_CTRL2_RIIE		0x0004
#define SCI_CTRL2_RIEIE		0x0010
/* SCI CTRL3 bits */
#define SCI_CTRL3_SHEN		0x0001

#if SCI_VERSION >= 6
    #define SCI_CTRL3_SBRH        0xE000
/* SCI RATE bits */
    #define SCI_RATE_SBRL         0xFFF8
    #define SCI_SBRH_MASK         0xE000
#else
    #define SCI_RATE_SBR          0xFFF8
#endif

#define SCI_RATE_FRAC_SBR     0x0007
#define SCI_SBRL_MASK         0x1FFF

//#endif

/* SCI STAT bits */
#define SCI_STAT_RDMA		0x0002
#define SCI_STAT_TDMA		0x0004
#define SCI_STAT_RIEF       0x0010
#endif
...
#define ioctlSCI_SET_BAUDRATE(pSciBase, param) \
        periphBitGrpSet(SCI_CTRL3_SBRH, (((param)>>3) & SCI_SBRH_MASK), &((pSciBase)->ctrl3)); \
        periphBitGrpSet(SCI_RATE_SBRL, ((param) & 0xffff), &((pSciBase)->rate)) 
#elif SCI_VERSION < 6
#define ioctlSCI_SET_BAUDRATE(pSciBase, param) \
...
#define ioctlSCI_SET_FRACTIONAL_BAUDRATE(pSciBase, param) \
    periphBitGrpSet(SCI_RATE_FRAC_SBR, param, &((pSciBase)->rate))

#define ioctlSCI_DMA_RECEIVER(pSciBase, param)      \
  if (param) periphBitSet (SCI_CTRL2_RDE, &((pSciBase)->scicr2)); \
  else periphBitClear (SCI_CTRL2_RDE, &((pSciBase)->scicr2))

#define ioctlSCI_DMA_TRANSMITTER(pSciBase, param)      \
  if (param) periphBitSet (SCI_CTRL2_TDE, &((pSciBase)->scicr2)); \
  else periphBitClear (SCI_CTRL2_TDE, &((pSciBase)->scicr2))

#define ioctlSCI_RECEIVER_IDLE_INT(pSciBase, param)      \
  if (param) periphBitSet (SCI_CTRL2_RIIE, &((pSciBase)->scicr2)); \
  else periphBitClear (SCI_CTRL2_RIIE, &((pSciBase)->scicr2))

#define ioctlSCI_RECEIVER_INPUT_EDGE_INT(pSciBase, param)      \
  if (param) periphBitSet (SCI_CTRL2_RIEIE, &((pSciBase)->scicr2)); \
  else periphBitClear (SCI_CTRL2_RIEIE, &((pSciBase)->scicr2))

#define ioctlSTOP_MODE_ENTRY_HOLD_OFF(pSciBase, param)      \
  if (param) periphBitSet(SCI_CTRL3_SHEN, &((pSciBase)->ctrl3)); \
  else periphBitClear (SCI_CTRL3_SHEN, &((pSciBase)->ctrl3))

#define ioctlSCI_RECEIVE_DMA_REQ(pSciBase, param)  \
  periphBitTest(SCI_STAT_RDMA, &((pSciBase)->stat))

#define ioctlSCI_TRANSMIT_DMA_REQ(pSciBase, param)  \
  periphBitTest(SCI_STAT_TDMA, &((pSciBase)->stat))

#define ioctlSCI_RECEIVER_INPUT_EDGE_FLAG(pSciBase, param)  \
  periphBitTest(SCI_STAT_RIEF, &((pSciBase)->stat))

#define ioctlSCI_READ_CONTROL_REG_3(pSciBase, param)      \
   periphMemRead (&((pSciBase)->ctrl3))

#define ioctlSCI_WRITE_CONTROL_REG_3(pSciBase, param)     \
   periphMemWrite (param, &((pSciBase)->ctrl3))
#endif
