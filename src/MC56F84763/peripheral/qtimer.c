...
#pragma unused(pTimerBase)
	...
	if (pTimerBase == QTIMER_A0) {
		...
		#endif			
		#ifdef QT_A0_DMA_INIT
			periphMemWrite(QT_A0_DMA_INIT, &pTimerBase->dma);
		#endif				
	}
	else 
#endif
	...
	if (pTimerBase == QTIMER_A1) {
		...
		#endif
		#ifdef QT_A1_DMA_INIT
			periphMemWrite(QT_A1_DMA_INIT, &pTimerBase->dma);
		#endif	
	}
	else 
#endif
	...
	if (pTimerBase == QTIMER_A2) {
		...
		#endif
		#ifdef QT_A2_DMA_INIT
			periphMemWrite(QT_A2_DMA_INIT, &pTimerBase->dma);
		#endif	
	}
	else 
#endif
	...
	if (pTimerBase == QTIMER_A3) {
		...
		#endif
		#ifdef QT_A3_DMA_INIT
			periphMemWrite(QT_A3_DMA_INIT, &pTimerBase->dma);
		#endif	
	}
	else
#endif
	...
	if (pTimerBase == QTIMER_B0) {
		...
		#endif
		#ifdef QT_B0_DMA_INIT
			periphMemWrite(QT_B0_DMA_INIT, &pTimerBase->dma);
		#endif	
	}
	else 
#endif
	...
	if (pTimerBase == QTIMER_B1) {
		...
		#endif
		#ifdef QT_B1_DMA_INIT
			periphMemWrite(QT_B1_DMA_INIT, &pTimerBase->dma);
		#endif	
	}
	else 
#endif
	...
	if (pTimerBase == QTIMER_B2) {
		...
		#endif
		#ifdef QT_B2_DMA_INIT
			periphMemWrite(QT_B2_DMA_INIT, &pTimerBase->dma);
		#endif	
	}
	else 
#endif
	...
	if (pTimerBase == QTIMER_B3) {
		...
		#endif
		#ifdef QT_B3_DMA_INIT
			periphMemWrite(QT_B3_DMA_INIT, &pTimerBase->dma);
		#endif	
	}
	else
#endif
	...
	if (pTimerBase == QTIMER_C0) {
		...
		#endif	
		#ifdef QT_C0_DMA_INIT
			periphMemWrite(QT_C0_DMA_INIT, &pTimerBase->dma);
		#endif	
	}
	else 
#endif
	...
	if (pTimerBase == QTIMER_C1) {
		...
		#endif
		#ifdef QT_C1_DMA_INIT
			periphMemWrite(QT_C1_DMA_INIT, &pTimerBase->dma);
		#endif
	}
	else 
#endif
	...
	if (pTimerBase == QTIMER_C2) {
		...
		#endif
		#ifdef QT_C2_DMA_INIT
			periphMemWrite(QT_C2_DMA_INIT, &pTimerBase->dma);
		#endif
	}
	else 
#endif
	...
	if (pTimerBase == QTIMER_C3) {
		...
		#endif
		#ifdef QT_C3_DMA_INIT
			periphMemWrite(QT_C3_DMA_INIT, &pTimerBase->dma);
		#endif
	}
	else
#endif
	...
	if (pTimerBase == QTIMER_D0) {
		...
		#endif
		#ifdef QT_D0_DMA_INIT
			periphMemWrite(QT_D0_DMA_INIT, &pTimerBase->dma);
		#endif
	}
	else 
#endif
	...
	if (pTimerBase == QTIMER_D1) {
		...
		#endif
		#ifdef QT_D1_DMA_INIT
			periphMemWrite(QT_D1_DMA_INIT, &pTimerBase->dma);
		#endif
	}
	else 
#endif
	...
	if (pTimerBase == QTIMER_D2) {
		...
		#endif
		#ifdef QT_D2_DMA_INIT
			periphMemWrite(QT_D2_DMA_INIT, &pTimerBase->dma);
		#endif
	}
	else 
#endif
	...
	if (pTimerBase == QTIMER_D3) {
		...
		#endif
		#ifdef QT_D3_DMA_INIT
			periphMemWrite(QT_D3_DMA_INIT, &pTimerBase->dma);
		#endif
	}
	else
#endif
	...
	if (pTimerBase == QTIMER_0) {
		...
		#endif
		#ifdef QT_0_DMA_INIT
			periphMemWrite(QT_0_DMA_INIT, &pTimerBase->dma);
		#endif	
	}
	else 
#endif
	...
	if (pTimerBase == QTIMER_1) {
		...
		#endif
		#ifdef QT_1_DMA_INIT
			periphMemWrite(QT_1_DMA_INIT, &pTimerBase->dma);
		#endif	
	}
	else 
#endif
	...
	if (pTimerBase == QTIMER_2) {
		...
		#endif
		#ifdef QT_2_DMA_INIT
			periphMemWrite(QT_2_DMA_INIT, &pTimerBase->dma);
		#endif	
	}
	else 
#endif
	...
	if (pTimerBase == QTIMER_3) {
		...
		#endif
		#ifdef QT_3_DMA_INIT
			periphMemWrite(QT_3_DMA_INIT, &pTimerBase->dma);
		#endif	
	}
	else
#endif
