...
* (c) Copyright 2004-20012 Freescale Semiconductor, Inc.
* ALL RIGHTS RESERVED.
*
********************************************************************************
*
...
#define archEnableIntLvl123() asm { bfset #0x0300,SR; nop; nop; nop; nop; nop; nop; bfclr #0x0200,SR }
#define archEnableIntLvl23()  asm { bfset #0x0300,SR; nop; nop; nop; nop; nop; nop; bfclr #0x0100,SR }
